...
for i in movieTitleArray {
    print("\(i) with Puppets!")
}
...
for i in oldMountainViewRent {
    newMountainViewRent.append(i*1.2)
}
...
switch (myMove.rawValue, yourMove.rawValue) {
case (0, 1), (1, 0):
    resultsMessage = "Paper covers Rock."
case (0, 0), (1, 1), (2, 2):
    resultsMessage = "It's a tie!"
case (2, 0), (0, 2):
    resultsMessage = "Rock cruches Scissors."
case (1, 2), (2, 1):
...
var word = "can"
var firstLetter = word[word.startIndex] // c
var newWord = ""
